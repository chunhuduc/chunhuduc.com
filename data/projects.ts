...
export const projects: ProjectCard[] = [
  ...
  },
  {
    ...
    outcome: "Enterprise multilingual platform serving EN/AR audiences with Sitecore XM Cloud and global CDN delivery.",
  },
  {
    ...
    outcome: "Multi-region abuse mitigation protecting premium content at CDN edge across millions of playback sessions.",
  },
  {
    ...
    outcome: "End-to-end pipeline from source scrape to published post — hands-free for individual creators.",
  },
];
