        ...
        <RevealStaggerRoot>
          <div className="flex flex-col gap-12 lg:grid lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] lg:items-start lg:gap-x-14 py-10">
            ...
            <div className="flex flex-col gap-5">
              <div
                className="flex flex-row items-start gap-4 sm:gap-5 reveal-stagger-item"
                style={ro()}
              >
            ...
            <div className="flex flex-col gap-10">
              <h2
                className="flex flex-wrap items-center gap-2 text-2xl font-extrabold tracking-tight text-foreground sm:text-[1.65rem] reveal-stagger-item"
                style={ro()}
              >
                Get in touch
          ...
          <div className="mx-auto w-[95%] max-w-xl sm:w-full sm:max-w-none reveal-stagger-item" style={ro()}>
          ...
          <div className="flex flex-col items-center gap-8 py-0 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-8 sm:gap-y-4">
            <ul
              className="flex max-w-[min(100%,22rem)] flex-wrap justify-center gap-x-5 gap-y-3 text-center text-sm sm:max-w-none sm:justify-start sm:text-left sm:gap-x-8 reveal-stagger-item"
              style={ro()}
            >
              {navItems.map((item) => (
            ...
            <p
              className="max-w-[min(100%,20rem)] text-center text-[11px] leading-relaxed text-muted sm:max-w-none sm:text-right sm:text-xs md:text-sm reveal-stagger-item"
              style={ro()}
            >
