...
const chipClassName =
  "inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[0.65rem] bg-white text-[#0c0d10] shadow-[0_3px_16px_rgba(0,0,0,0.22)] transition-opacity hover:opacity-[0.82]";
